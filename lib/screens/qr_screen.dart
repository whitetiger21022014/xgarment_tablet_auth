...
class QRScreen extends StatefulWidget {
  ...
  final String title;
  QRScreen({Key? key, this.onScan, this.title = 'Quét mã QR'}) : super(key: key);
...
class _QRScreenState extends State<QRScreen> {
  ...
  void _onDetect(BarcodeCapture capture) {
    ...
    if (barcodes.isNotEmpty && barcodes.first.rawValue != null) {
      ...
      // Đóng màn hình quét, trả về dữ liệu
  ...
  Widget build(BuildContext context) {
    if (_permissionDenied) {
      return Scaffold(
        ...
        body: const Center(
          child: Text(
            "Ứng dụng cần quyền Camera để quét QR!",
      ...
      body: _cameraReady
          ? Stack(
              children: [
                ...
                // Custom UI overlay cho khung quét QR
                Align(
